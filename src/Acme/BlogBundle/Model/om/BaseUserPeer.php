...
use Acme\BlogBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer {
	...
	const OM_CLASS = 'Acme\\BlogBundle\\Model\\User';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Salt', 'Password', 'Roles', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'salt', 'password', 'roles', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::SALT, self::PASSWORD, self::ROLES, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'SALT', 'PASSWORD', 'ROLES', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'salt', 'password', 'roles', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Salt' => 2, 'Password' => 3, 'Roles' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'salt' => 2, 'password' => 3, 'roles' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::SALT => 2, self::PASSWORD => 3, self::ROLES => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'SALT' => 2, 'PASSWORD' => 3, 'ROLES' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'salt' => 2, 'password' => 3, 'roles' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
