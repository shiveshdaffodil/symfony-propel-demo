 ...
 *
 * @package    propel.generator.src.Acme.LibraryBundle.Model.om
 */
abstract class BaseAuthorQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Acme\\LibraryBundle\\Model\\Author', $modelAlias = null)
	{
