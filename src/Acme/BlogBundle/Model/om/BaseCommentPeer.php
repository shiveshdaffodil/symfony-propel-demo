...
use Acme\BlogBundle\Model\map\CommentTableMap;
...
abstract class BaseCommentPeer {
	...
	const OM_CLASS = 'Acme\\BlogBundle\\Model\\Comment';
	...
	const CREATED_BY = 'comments.CREATED_BY';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PostId', 'Content', 'CreatedBy', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'postId', 'content', 'createdBy', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::POST_ID, self::CONTENT, self::CREATED_BY, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'POST_ID', 'CONTENT', 'CREATED_BY', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'post_id', 'content', 'created_by', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PostId' => 1, 'Content' => 2, 'CreatedBy' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'postId' => 1, 'content' => 2, 'createdBy' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::POST_ID => 1, self::CONTENT => 2, self::CREATED_BY => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'POST_ID' => 1, 'CONTENT' => 2, 'CREATED_BY' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'post_id' => 1, 'content' => 2, 'created_by' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CommentPeer::CREATED_BY);
		} else {
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CommentPeer::CREATED_BY, UserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Comment objects pre-filled with their Post objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinPost(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comment) to $obj2 (Post)
